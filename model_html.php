...
<script type="text/javascript">
    $(document).ready(function () {
        $('#img1').on('change', function() {
			var img_data = $(this).prop('files')[0];
			var form_data = new FormData();  // Create a FormData object
			form_data.append('file', img_data); // Append all element in FormData  object
			...
			$.ajax({
					...
					success     : function(output){
						$('#img1').val(output);            // display response from the PHP script, if any
					}
			 });
		});
  ...
  <div class="container-fluid">
    ...
    <form action='#' method="post">
        ...
        <div class="form-group">
			<div class="row">
				<div class="col-xs-6">
					<select class='form-control manufacturer' id='manufacturer' name="manufacturer">
        ...
        <div class="form-group">
			<div class="row">
				...
				<div class="col-xs-6">
					<input type="text" class="form-control" name="year" placeholder="Manufacturing Year">
				</div>
			</div>
        </div>
        <div class="form-group">
